...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}/Users/edwsurewin/anaconda/lib/python2.7/site-
packages/matplotlib/font\_manager.py:1236: UserWarning: findfont: Font
family ['normal'] not found. Falling back to Bitstream Vera Sans
...
\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_6_1.png}
    \par
    \end{center}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}--- Please select a CRAN mirror for use in this session ---
\end{alltt}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}Loading required package: zoo
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}[<matplotlib.lines.Line2D at 0x110269290>]\end{alltt}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}[<matplotlib.lines.Line2D at 0x11080d4d0>]\end{alltt}
...
financial crisis is persistent\section{Test Suite}\label{test-suite}
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{file} \PY{n}{calc\PYZus{}len}\PY{o}{.}\PY{n}{py}
\PY{k}{def} \PY{n+nf}{calc\PYZus{}len}\PY{p}{(}\PY{n}{maxprice}\PY{p}{)}\PY{p}{:}
    \PY{n}{highmaxprice} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{maxprice}\PY{p}{)}\PY{p}{)}\PY{p}{:}
	\PY{k}{if} \PY{n}{maxprice}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{\PYZgt{}} \PY{l+m+mi}{1000}\PY{p}{:}
		\PY{n}{highmaxprice} \PY{o}{=} \PY{n}{highmaxprice} \PY{o}{+} \PY{p}{[}\PY{n}{maxprice}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}
    \PY{k}{return} \PY{n}{highmaxprice}

\PY{k}{def} \PY{n+nf}{test\PYZus{}1}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{n}{result} \PY{o}{=} \PY{n}{calc\PYZus{}len}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{25.682}\PY{p}{,} \PY{l+m+mf}{25.681}\PY{p}{,} \PY{l+m+mf}{47.705}\PY{p}{,} \PY{l+m+mf}{58.268}\PY{p}{,} \PY{l+m+mf}{70.173}\PY{p}{,} \PY{l+m+mf}{91.905}\PY{p}{,} \PY{l+m+mf}{91.904}\PY{p}{,} \PY{l+m+mf}{102.997}\PY{p}{,} \PY{l+m+mf}{114.752}\PY{p}{,} \PY{l+m+mf}{103.464}\PY{p}{,} \PY{l+m+mf}{133.155}\PY{p}{,} \PY{l+m+mf}{133.148}\PY{p}{,} \PY{l+m+mf}{166.107}\PY{p}{,} \PY{l+m+mf}{166.107}\PY{p}{,} \PY{l+m+mf}{309.770}\PY{p}{,} \PY{l+m+mf}{467.390}\PY{p}{,} \PY{l+m+mf}{467.385}\PY{p}{,} \PY{l+m+mf}{1465.450}\PY{p}{,} \PY{l+m+mf}{1465.411}\PY{p}{,} \PY{l+m+mf}{1506.617}\PY{p}{,} \PY{l+m+mf}{1317.946}\PY{p}{,} \PY{l+m+mf}{1317.928}\PY{p}{,} \PY{l+m+mf}{1814.799}\PY{p}{,} \PY{l+m+mf}{1814.949}\PY{p}{]}\PY{p}{)}
    \PY{k}{print} \PY{l+s}{\PYZsq{}}\PY{l+s}{hello, this is a test; the value of result is}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{result}\PY{p}{)}
    \PY{k}{assert} \PY{n+nb}{len}\PY{p}{(}\PY{n}{result}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mi}{10}
\end{Verbatim}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.text.Text at 0x11081ee50>\end{alltt}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.legend.Legend at 0x10a6b2b10>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_66_1.png}
    \par
    \end{center}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.legend.Legend at 0x110235090>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_67_1.png}
    \par
    \end{center}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.legend.Legend at 0x1102bd5d0>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_68_1.png}
    \par
    \end{center}
  ...
  \fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.legend.Legend at 0x1102a7690>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_89_1.png}
    \par
    \end{center}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.legend.Legend at 0x110eb8310>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_93_1.png}
    \par
    \end{center}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.legend.Legend at 0x1102a8310>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_94_1.png}
    \par
    \end{center}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}('Monte Carlo Bootstrapping with mean', 0.99996462634803396,
'variance', 3.7924358331153477e-07)
\end{alltt}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}(array([   22161.68628455,    44323.37256911,    55404.21571138,
          88646.74513822,   110808.43142277,   155131.80399188,
         332425.29426831,   565123.00025613,   487557.09826019,
         764578.17681711,   753497.33367484,   986195.03966265,
        1152407.68679681,   952952.51023582,   908629.13766671,
         886467.45138216,   842144.07881305,   731335.64739028,
         387829.50997969,   332425.29426831,   210536.01970326,
         121889.27456505,    99727.58828049,    44323.37256911,
          44323.37256911]),
 array([ 0.99996345,  0.99996354,  0.99996363,  0.99996372,
0.99996381,
        0.9999639 ,  0.99996399,  0.99996408,  0.99996417,
0.99996426,
        0.99996435,  0.99996444,  0.99996453,  0.99996462,
0.99996471,
        0.9999648 ,  0.99996489,  0.99996498,  0.99996507,
0.99996516,
        0.99996525,  0.99996534,  0.99996543,  0.99996552,
0.99996561,
        0.9999657 ]),
 <a list of 25 Patch objects>)\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_98_1.png}
    \par
    \end{center}
 ...
 \fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_102_0.png}
    \par
    \end{center}
...
\fi
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{Final_Report_files/Final_Report_103_0.png}
    \par
    \end{center}
...
\section{Test Suite}\label{test-suite}
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{file} \PY{n}{Weekend\PYZus{}test1}\PY{o}{.}\PY{n}{py}

\PY{k+kn}{import} \PY{n+nn}{os}
\PY{k+kn}{import} \PY{n+nn}{scipy.stats} \PY{k+kn}{as} \PY{n+nn}{stats}
\PY{n}{os}\PY{o}{.}\PY{n}{chdir}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{/Users/edwsurewin/Dropbox/Berkeley MA/222/STAT222\PYZhy{}SP500}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{c}{\PYZsh{} or elsewhere at which \PYZdq{}SP500.csv\PYZdq{} is stored}

\PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k+kn}{as} \PY{n+nn}{pd}
\PY{n}{SP500} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{SP500.csv}\PY{l+s}{\PYZdq{}}\PY{p}{)}

\PY{c}{\PYZsh{}print(SP500.tail()) = 0 to 16146}
\PY{c}{\PYZsh{}len(SP500[\PYZsq{}Day\PYZsq{}]) = 16147}

\PY{n}{rate} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Open}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{compute\PYZus{}rate}\PY{p}{(}\PY{n}{SP500}\PY{p}{,} \PY{n}{rate}\PY{p}{)}\PY{p}{:}
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Open}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
        \PY{n}{rate}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Open}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{/}\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Adj Close}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}
    \PY{k}{return} \PY{n}{rate}

\PY{n}{rate} \PY{o}{=} \PY{n}{compute\PYZus{}rate}\PY{p}{(}\PY{n}{SP500}\PY{p}{,} \PY{n}{rate}\PY{p}{)}

\PY{c}{\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}}
\PY{c}{\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{} TEST SUITE \PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}}
\PY{c}{\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}\PYZsh{}}

\PY{k}{def} \PY{n+nf}{test\PYZus{}1}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c}{\PYZsh{} if index 1 is correct}
    \PY{n}{abc} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Open}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
    \PY{n}{result} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{compute\PYZus{}rate}\PY{p}{(}\PY{n}{SP500}\PY{p}{,} \PY{n}{abc}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{)}
    \PY{k}{assert} \PY{n}{result} \PY{o}{==} \PY{n+nb}{round}\PY{p}{(}\PY{l+m+mf}{1.0000747101}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{test\PYZus{}2}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c}{\PYZsh{} if index 88 is correct}
    \PY{n}{abc} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Open}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
    \PY{n}{result} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{compute\PYZus{}rate}\PY{p}{(}\PY{n}{SP500}\PY{p}{,} \PY{n}{abc}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{88}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{)}
    \PY{k}{assert} \PY{n}{result} \PY{o}{==} \PY{n+nb}{round}\PY{p}{(}\PY{l+m+mf}{0.999801110372}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{test\PYZus{}3}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c}{\PYZsh{} if index 777 is correct}
    \PY{n}{abc} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Open}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
    \PY{n}{result} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{compute\PYZus{}rate}\PY{p}{(}\PY{n}{SP500}\PY{p}{,} \PY{n}{abc}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{777}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{)}
    \PY{k}{assert} \PY{n}{result} \PY{o}{==} \PY{n+nb}{round}\PY{p}{(}\PY{l+m+mf}{1.00234814792}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)}
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}Overwriting Weekend\_test1.py
\end{alltt}
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{file} \PY{n}{Weekend\PYZus{}test2}\PY{o}{.}\PY{n}{py}
...
\PY{n}{SP500} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{SP500.csv}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\PY{n}{SP500}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{Day}\PY{l+s}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{null}\PY{l+s}{\PYZdq{}}
...
\PY{n}{Monday} \PY{o}{=} \PY{p}{[}\PY{p}{]}       \PY{c}{\PYZsh{} dynamic list}
\PY{n}{Tuesday} \PY{o}{=} \PY{p}{[}\PY{p}{]}      \PY{c}{\PYZsh{} create daily rate, in reference to \PYZdq{}close adj\PYZdq{} day}
\PY{n}{Wednesday} \PY{o}{=} \PY{p}{[}\PY{p}{]}    \PY{c}{\PYZsh{} thus, control group is Friday, i.e. 5}
\PY{n}{Thursday} \PY{o}{=} \PY{p}{[}\PY{p}{]}     \PY{c}{\PYZsh{} if the subsequent Monday is a holiday, then (Tue\PYZsq{}s open / Friday\PYZsq{}s close) = raw rate}
\PY{n}{Friday} \PY{o}{=} \PY{p}{[}\PY{p}{]}       
...
\PY{n}{kde}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{Friday}\PY{o}{+}\PY{n}{NonFri}\PY{p}{)}
\PY{n}{ker100} \PY{o}{=} \PY{n}{kde}\PY{o}{.}\PY{n}{sample}\PY{p}{(}\PY{n}{n\PYZus{}samples}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{)}
...
\PY{k}{def} \PY{n+nf}{test\PYZus{}4}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c}{\PYZsh{} if index 1 is correct}
    \PY{n}{BootMean} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{n+nb}{len}\PY{p}{(}\PY{n}{MonteCarloBoot}\PY{p}{)}
    \PY{n}{result} \PY{o}{=} \PY{n}{bootMean}\PY{p}{(}\PY{n}{MonteCarloBoot}\PY{p}{,} \PY{n}{BootMean}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
    \PY{k}{assert} \PY{n}{result} \PY{o}{==} \PY{n}{MonteCarloBoot}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
    
\PY{k}{def} \PY{n+nf}{test\PYZus{}5}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c}{\PYZsh{} if index 10 is correct}
    \PY{n}{BootMean} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{n+nb}{len}\PY{p}{(}\PY{n}{MonteCarloBoot}\PY{p}{)}
    \PY{n}{result} \PY{o}{=} \PY{n}{bootMean}\PY{p}{(}\PY{n}{MonteCarloBoot}\PY{p}{,} \PY{n}{BootMean}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{10}\PY{p}{]}
    \PY{k}{assert} \PY{n}{result} \PY{o}{==} \PY{n}{MonteCarloBoot}\PY{p}{[}\PY{l+m+mi}{10}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
    
\PY{k}{def} \PY{n+nf}{test\PYZus{}6}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c}{\PYZsh{} if index 100 is correct}
    \PY{n}{BootMean} \PY{o}{=} \PY{p}{[}\PY{n+nb+bp}{None}\PY{p}{]}\PY{o}{*}\PY{n+nb}{len}\PY{p}{(}\PY{n}{MonteCarloBoot}\PY{p}{)}
    \PY{n}{result} \PY{o}{=} \PY{n}{bootMean}\PY{p}{(}\PY{n}{MonteCarloBoot}\PY{p}{,} \PY{n}{BootMean}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{100}\PY{p}{]}
    \PY{k}{assert} \PY{n}{result} \PY{o}{==} \PY{n}{MonteCarloBoot}\PY{p}{[}\PY{l+m+mi}{100}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}Overwriting Weekend\_test2.py
\end{alltt}
